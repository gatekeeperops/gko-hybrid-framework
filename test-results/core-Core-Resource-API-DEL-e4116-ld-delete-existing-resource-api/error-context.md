...
- Name: api\core.spec.ts >> Core Resource API >> DELETE /api/v1/resources/:id >> should delete existing resource
- Location: tests\api\core.spec.ts:145:9

# Error details

```
Error: Expected status 204 but got 403.
