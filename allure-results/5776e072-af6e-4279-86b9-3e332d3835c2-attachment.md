...
- Name: api\core.spec.ts >> Core Resource API >> POST /api/v1/resources >> should create a new resource
- Location: tests\api\core.spec.ts:43:9

# Error details

```
Error: Expected status 201 but got 422.
Body: {"price":["The price field is required."],"category_id":["The category id field is required."],"brand_id":["The brand id field is required."],"is_location_offer":["The is location offer field is required."],"is_rental":["The is rental field is required."],"product_image_id":["The product image id field is required."]}
```
